...
Donde dice: Agrega el link al repositorio de tu cuenta de github, reemplaza <tuusuario> por tu cuenta
git remote add origin [https://github.com/](https://github.com/ "https://github.com/")<tuusuario>/fe3-final Hay que reemplazar no solo el usuario sino que todo el link con el del repo que uno tenga creado, ya que nos piden que tenga nombre: ctd-esp-fe3-final y no fe3-final
